...
import com.voximplant.apiclient.request.GetAuditLogAsyncRequest;
import com.voximplant.apiclient.response.GetAuditLogAsyncResponse;
...
*/
public class GetAuditLogAsyncExample {
    public static void main(String [] args) {
        try {
            ...
            GetAuditLogAsyncResponse res = client.getAuditLogAsync(new GetAuditLogAsyncRequest()
