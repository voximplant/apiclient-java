...
*/
public class SIPRegistrationRecoveredCallback implements Alignable {

    private SIPRegistrationIsRecoveredCallbackItem[] sipRegistrations;

    /**
    * SIP registration array
    */
    public SIPRegistrationIsRecoveredCallbackItem[] getSipRegistrations() {
    ...
    public String toString(int alignment) {
        ...
        if (sipRegistrations != null) {
            sb.append(aligned)
                .append("\"SIPRegistrationIsRecoveredCallbackItem\": ")
