...
public class RequestSmartQueueHistoryRequest implements Alignable {
    ...
    * types
    */
    public RequestSmartQueueHistoryRequest setUserId(MultiArgument<Long> d) {
        this.userId = d;
        return this;
    }
    ...
    /**
    * The user name list separated by semicolon (;). Can be used instead of
    * <b>user_id</b>
    */
    ...
    * <b>user_id</b>
    */
    public RequestSmartQueueHistoryRequest setUserName(MultiArgument<String> d) {
        this.userName = d;
        return this;
    }
    ...
    * types
    */
    public RequestSmartQueueHistoryRequest setSqQueueId(MultiArgument<Long> d) {
        this.sqQueueId = d;
        return this;
    }
    ...
    * HH:mm:ss. Default is the current time minus 1 day
    */
    public RequestSmartQueueHistoryRequest setFromDate(Date d) {
        this.fromDate = d;
        return this;
    }
    ...
    * HH:mm:ss. Default is the current time
    */
    public RequestSmartQueueHistoryRequest setToDate(Date d) {
        this.toDate = d;
        return this;
    }
    ...
    * The selected timezone or the 'auto' value (the account location)
    */
    public RequestSmartQueueHistoryRequest setTimezone(String d) {
        this.timezone = d;
        return this;
    }
    ...
    * Interval format: YYYY-MM-DD HH:mm:ss. Default is 1 day
    */
    public RequestSmartQueueHistoryRequest setInterval(String d) {
        this.interval = d;
        return this;
    }
    ...
    * im_count_abandonment_chats, im_count_lost_chats, im_lost_chats_rate
    */
    public RequestSmartQueueHistoryRequest setReportType(MultiArgument<String> d) {
        this.reportType = d;
        return this;
    }
    ...
    * max_after_call_worktime, average_after_call_worktime report types
    */
    public RequestSmartQueueHistoryRequest setGroupBy(String d) {
        this.groupBy = d;
        return this;
    }
    ...
    * Maximum waiting time. Required for the **service_level** report type
    */
    public RequestSmartQueueHistoryRequest setMaxWaitingSec(long d) {
