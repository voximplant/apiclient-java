...
public class GetSmartQueueDayHistoryRequest implements Alignable {
    ...
    * The application ID to search by
    */
    public GetSmartQueueDayHistoryRequest setApplicationId(long d) {
    ...
    * <b>application_id</b> parameter
    */
    public GetSmartQueueDayHistoryRequest setApplicationName(String d) {
    ...
    * types
    */
    public GetSmartQueueDayHistoryRequest setUserId(MultiArgument<Long> d) {
        this.userId = d;
        return this;
    }
    ...
    * be used instead of <b>user_id</b>
    */
    public GetSmartQueueDayHistoryRequest setUserName(MultiArgument<String> d) {
        this.userName = d;
        return this;
    }
    ...
    * types
    */
    public GetSmartQueueDayHistoryRequest setSqQueueId(MultiArgument<Long> d) {
        this.sqQueueId = d;
        return this;
    }
    ...
    * instead of <b>sq_queue_id</b>
    */
    public GetSmartQueueDayHistoryRequest setSqQueueName(MultiArgument<String> d) {
        this.sqQueueName = d;
        return this;
    }
    ...
    * HH:mm:ss. Default is the current time minus 1 day
    */
    public GetSmartQueueDayHistoryRequest setFromDate(Date d) {
        this.fromDate = d;
        return this;
    }
    ...
    * HH:mm:ss. Default is the current time
    */
    public GetSmartQueueDayHistoryRequest setToDate(Date d) {
        this.toDate = d;
        return this;
    }
    ...
    * The selected timezone or the 'auto' value (the account location)
    */
    public GetSmartQueueDayHistoryRequest setTimezone(String d) {
        this.timezone = d;
        return this;
    }
    ...
    * Interval format: YYYY-MM-DD HH:mm:ss. Default is 1 day
    */
    public GetSmartQueueDayHistoryRequest setInterval(String d) {
        this.interval = d;
        return this;
    }
    ...
    * call_count_assigned_to_queue, im_count_assigned_to_queue
    */
    public GetSmartQueueDayHistoryRequest setReportType(MultiArgument<String> d) {
        this.reportType = d;
        return this;
    }
    ...
    * max_after_call_worktime, average_after_call_worktime report types
    */
    public GetSmartQueueDayHistoryRequest setGroupBy(String d) {
        this.groupBy = d;
        return this;
    }
    ...
    * Maximum waiting time. Required for the **service_level** report type
    */
    public GetSmartQueueDayHistoryRequest setMaxWaitingSec(long d) {
