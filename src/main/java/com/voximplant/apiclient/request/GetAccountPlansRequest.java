...
public class GetAccountPlansRequest implements Alignable {
    ...
    * are IM, MAU
    */
    public GetAccountPlansRequest setPlanType(MultiArgument<String> d) {
        this.planType = d;
        return this;
    }
    ...
    * The plan ID list separated by semicolons (;)
    */
    public GetAccountPlansRequest setPlanSubscriptionTemplateId(MultiArgument<Long> d) {
