...
public class SQ_SetQueueInfoRequest implements Alignable {
    ...
    * ID of the application to search by
    */
    public SQ_SetQueueInfoRequest setApplicationId(long d) {
    ...
    * <b>application_id</b>
    */
    public SQ_SetQueueInfoRequest setApplicationName(String d) {
    ...
    */
    ...
    public boolean hasNewSqQueueName() {
        return this.newSqQueueName != null;
    }
    ...
    * values: "MOST_QUALIFIED", "LEAST_QUALIFIED", "MAX_WAITING_TIME"
    */
    public SQ_SetQueueInfoRequest setCallAgentSelection(String d) {
    ...
    * of the following values: "MAX_PRIORITY", "MAX_WAITING_TIME"
    */
    public SQ_SetQueueInfoRequest setCallTaskSelection(String d) {
    ...
    * a suitable free agent. Currently not used
    */
    public SQ_SetQueueInfoRequest setFallbackAgentSelection(String d) {
    ...
    * Comment, up to 200 characters
    */
    public SQ_SetQueueInfoRequest setDescription(String d) {
        this.description = d;
        return this;
    }
    ...
    * parameters simultaniously leads to an error
    */
    public SQ_SetQueueInfoRequest setCallMaxWaitingTime(long d) {
    ...
    * parameters simultaniously leads to an error
    */
    public SQ_SetQueueInfoRequest setImMaxWaitingTime(long d) {
    ...
    * Maximum size of the queue with CALL-type requests
    */
    public SQ_SetQueueInfoRequest setCallMaxQueueSize(long d) {
    ...
    * Maximum size of the queue with IM-type requests
    */
    public SQ_SetQueueInfoRequest setImMaxQueueSize(long d) {
    ...
    * The queue's priority from 1 to 100
    */
    public SQ_SetQueueInfoRequest setPriority(long d) {
    ...
    * leads to an error
    */
    public SQ_SetQueueInfoRequest setCallMaxWaitingTimeInSeconds(long d) {
    ...
    * simultaniously leads to an error
    */
    public SQ_SetQueueInfoRequest setImMaxWaitingTimeInSeconds(long d) {
