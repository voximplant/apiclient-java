...
public class GetKeyValueItemsRequest implements Alignable {
    private String key;
    ...
    * Namespace that keys should contain, up to 200 characters
    */
    public GetKeyValueItemsRequest setKey(String d) {
        this.key = d;
        return this;
    }
    ...
    * value is 10
    */
    public GetKeyValueItemsRequest setCount(long d) {
    ...
    * the items shown earlier). Default value is 0
    */
    public GetKeyValueItemsRequest setOffset(long d) {
    ...
    * The application ID
    */
    public GetKeyValueItemsRequest setApplicationId(long d) {
    ...
    * The application name
    */
    public GetKeyValueItemsRequest setApplicationName(String d) {
