...
public class SetWABPhoneNumberInfoRequest implements Alignable {
    ...
    * WhatsApp Business phone number to change details for
    */
    public SetWABPhoneNumberInfoRequest setWabPhoneNumber(String d) {
    ...
    * New WhatsApp Business SIP password
    */
    public SetWABPhoneNumberInfoRequest setVoicePassword(String d) {
    ...
    * New WhatsApp Business phone number description
    */
    public SetWABPhoneNumberInfoRequest setDescription(String d) {
        this.description = d;
        return this;
    }
    ...
    * Bound application ID
    */
    public SetWABPhoneNumberInfoRequest setApplicationId(long d) {
    ...
    * <b>application_id</b>
    */
    public SetWABPhoneNumberInfoRequest setApplicationName(String d) {
    ...
    * Bound rule ID
    */
    public SetWABPhoneNumberInfoRequest setRuleId(long d) {
    ...
    * Bound rule name that can be used instead of <b>rule_id</b>
    */
    public SetWABPhoneNumberInfoRequest setRuleName(String d) {
        this.ruleName = d;
        return this;
    }
